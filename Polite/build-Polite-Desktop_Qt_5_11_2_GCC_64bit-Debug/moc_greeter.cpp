...
QT_MOC_LITERAL(1, 8, 10), // "textEdited"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4), // "text"
QT_MOC_LITERAL(4, 25, 22) // "greetingLineTextEdited"

    },
    "Greeter\0textEdited\0\0text\0"
    "greetingLineTextEdited"
};
...
void Greeter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->greetingLineTextEdited((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Greeter::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Greeter::textEdited)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Greeter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Greeter.data,
      qt_meta_data_Greeter,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Greeter::textEdited(const QString & _t1)
{
